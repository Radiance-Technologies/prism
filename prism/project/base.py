...
class Project(ABC):
    ...
    def build_debug(
        ...
        **build_kwargs
        ...
        If a normal build is successful, and breakpoint is None,
        SerAPI is not invoked.

        Parameters
        ----------
        breakpoint : Optional[SexpInfo.Loc], optional
        ...
        serapi : Optional[SerAPI]
            ...
            failure or prior to `breakpoint` if given.
            If `breakpoint` is not given and the project
        ...
        ExecutionError
            ...
            error encountered on the way.
        MissingMetadataError
            If `self.serapi_options` is `None`. Not expected in normal
            operation.
        ProjectCommandError
            If `make_single_file` fails to build a particular file.
        """
